(function() {
    ...
    */
    ...
    var wa = Array.prototype.forEach ? function(a, b) {
    ...
    var z, Ka = p.navigator;
    z = Ka ? Ka.userAgentData || null : null;

    function La(a) {
        return Fa ? z ? z.brands.some(function(b) {
    ...
    function Ma() {
        return B() ? La("Chromium") : (A("Chrome") || A("CriOS")) && !(B() ? 0 : A("Edge")) || A("Silk")
    };
    var Na = {},
        C = function(a, b) {
            this.g = b === Na ? a : ""
    ...
    var Ta = function(a) {
            ...
            return a.replace(Sa, function(d, e) {
                ...
                if (!g) {
                    ...
                    g = (e = v) ? e.createHTML(g) :
                        g;
                    g = new C(g, Na);
                    if (c.tagName && Qa[c.tagName.toUpperCase()]) throw Error("goog.dom.safe.setInnerHtml cannot be used to set content of " + c.tagName + ".");
                    if (Ra())
    ...
    chrome.cast.mb = function(a, b, c, d) {
        this.label = a;
        a = b;
        Ea.test(a) && (-1 != a.indexOf("&") && (a = a.replace(ya, "&amp;")), -1 != a.indexOf("<") && (a = a.replace(za, "&lt;")), -1 != a.indexOf(">") && (a = a.replace(Aa, "&gt;")), -1 != a.indexOf('"') && (a = a.replace(Ba, "&quot;")), -1 != a.indexOf("'") && (a = a.replace(Ca, "&#39;")), -1 != a.indexOf("\x00") && (a = a.replace(Da, "&#0;")));
        this.friendlyName = a;
        this.capabilities = c || [];
        this.volume = d || null;
    ...
    f.Vb = function(a, b, c) {
        D.o(this, "QUEUE_INSERT", new chrome.cast.media.ta([a]), b, c, chrome.cast.media.timeout.v)
    };
    f.hc = function(a, b, c) {
    ...
    f.cc = function(a, b, c) {
        0 > Va(this, a) || D.o(this, "QUEUE_REMOVE", new chrome.cast.media.va([a]), b, c, chrome.cast.media.timeout.v)
    };
    f.ec = function(a, b, c) {
    ...
    var M = function(a, b) {
            return L(a.h, b) ? (delete a.h[b], --a.size, a.j++, a.g.length > 2 * a.size && K(a), !0) : !1
        },
        K = function(a) {
    ...
    var vb = A("Gecko") && !(-1 != Ja().toLowerCase().indexOf("webkit") && !A("Edge")) && !(A("Trident") || A("MSIE")) && !A("Edge"),
    ...
    R.prototype.stop = function() {
        this.g && (p.clearTimeout(this.g), this.g = null, this.h = !1, this.m = null)
    };
    ...
    !A("Android") || Ma();
    Ma();
    A("Safari") && (Ma() || (B() ? 0 : A("Coast")) || (B() ? 0 : A("Opera")) || (B() ? 0 : A("Edge")) || (B() ? La("Microsoft Edge") : A("Edg/")) || B() && La("Opera"));
    var zb = {},
        S = null,
    ...
    var T = function() {
        ...
        U = function(a) {
            var b = typeof a;
            return "object" == b && a || "function" == b ? "o" + (Object.prototype.hasOwnProperty.call(a, oa) && a[oa] || (a[oa] = ++pa)) : b.slice(0, 1) + a
        };
    f = T.prototype;
    f.add = function(a) {
        this.g.set(U(a), a);
    ...
    var V = function() {
        ...
        W = function(a, b, c, d) {
            ...
            d = jb(a.A, b);
            c && d && (a =
                ib(a.K, b.sequenceNumber)) && (b = new chrome.cast.Error(chrome.cast.C.INVALID_PARAMETER, d), (a = a.g) && a(b))
        };
    V.prototype.initialize = function(a, b) {
        ...
        a.invisibleSender || (a = new PresentationRequest(X(this)), a.getAvailability().then(function(d) {
            ...
            Y(c, d.connection)
        }, this.ia = (p.navigator || null).presentation.defaultRequest = a, a.reconnect(chrome.cast.Ia).then(function(d) {
            Y(c,
                d)
        }, function() {}));
        b && b(void 0)
    ...
    var Y = function(a, b, c) {
        ...
        Hb = function(a) {
            var b = Z;
            Fb.has(a.type) && b.ja && (b.m ? (a.sessionId = b.m, Gb(b, null, a.type, a, function() {}, function() {})) : b.Va.A(X(b, void 0, "urn:x-cast:com.google.cast.media",
                a)))
        };
    ...
    V.prototype.requestSession = function(a, b, c) {
        var d = this;
        this.j ? Db(b) : (c = X(this, c), this.j = a, (new PresentationRequest(c)).start().then(function(e) {
            Y(d, e, b)
        }).catch(function(e) {
            d.j = null;
    ...
    var X = function(a, b, c, d) {
        ...
        var k = b.dialRequest;
        k && (e = k.appName, (g = k.launchParameter) && !g.match(Ib) && (g = Bb(g)));
        var l = [];
        l.push({
            appId: b.appId,
            capabilities: b.capabilities
        });
        b || wa(a.g.additionalSessionRequests, function(q) {
            l.push({
                appId: q.appId,
                capabilities: q.capabilities
            })
        });
        return nb(new mb(l, a.A.h, a.g.autoJoinPolicy, a.g.defaultActionPolicy, b.requestSessionTimeout, e, g, a.g.invisibleSender, c, d, b.androidReceiverCompatible, b.credentialsData))
    };
    V.prototype.Fa = function(a, b, c, d) {
        var e = this;
        this.D++;
        Gb(this, null, b, a, function(g) {
            e.D--;
            g.j = !0;
            c && c(g)
        }, function(g) {
    ...
    var Eb = function(a, b) {
        if (a.m) {
            ...
            pb(a.H, c, b) && (M(a.u, c), M(a.I, c), b = a.B.get(c)) && (M(a.B, c), F(b.s(), function(e) {
                e(d)
            }))
        }
    };
    V.prototype.onMessage = function(a) {
        ...
        if (b = ib(this.K, a.sequenceNumber)) "error" == a.type ? (b = b.g) && b(a.message) : (b = b.j) && b(a.message);
    ...
    var Lb = function(a, b) {
        ...
        Ib = RegExp("^([0-9a-zA-Z+/]{4})*(([0-9a-zA-Z+/]{2}==)|([0-9a-zA-Z+/]{3}=))?$"),
        Fb = new Set(["PRECACHE"]),
        Z = new V;
